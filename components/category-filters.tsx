...
export function CategoryFilters({ selectedCategories, toggleCategory }: CategoryFiltersProps) {
  return (
    <div className="w-full xl:w-48 xl:flex-shrink-0">
      ...
      <div className="flex gap-2 overflow-x-auto pb-1 -mx-1 xl:flex-col xl:overflow-visible xl:mx-0 xl:pb-0 xl:space-y-1">
        {categories.map((category) => {
          ...
          return (
            <button
              ...
              className={`flex items-start gap-3 p-3 rounded-lg border transition-all text-left flex-shrink-0 w-auto min-w-[160px] xl:w-full ${
                isSelected
