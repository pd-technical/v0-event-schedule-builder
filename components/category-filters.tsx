...
export function CategoryFilters({ selectedCategories, toggleCategory }: CategoryFiltersProps) {
  return (
    <div className="w-full md:w-48 md:flex-shrink-0">
      ...
      <div className="flex gap-2 overflow-x-auto pb-1 -mx-1 md:flex-col md:overflow-visible md:mx-0 md:pb-0 md:space-y-1">
        {categories.map((category) => {
          ...
          return (
            <button
              ...
              className={`flex items-start gap-3 p-3 rounded-lg border transition-all text-left flex-shrink-0 w-[180px] md:w-full ${
                isSelected
